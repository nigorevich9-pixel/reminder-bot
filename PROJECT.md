...
- `/hold <task_id>` — “приостановить” (на текущем MVP: событие логируется в core)
- `/ask <task_id> <text>` — уточнение/ответ пользователем (на текущем MVP: событие логируется в core)
